                  ...
                  <nav class="navbar navbar-expand-lg main-navbar">
                    <form class="form-inline mr-auto">
                      <ul class="navbar-nav mr-3">
                        ...
                        <li><a href="#" data-toggle="search"  class="nav-link nav-link-lg d-sm-none" style="width: 50%" ><i class="fas fa-search"></i></a></li>
                      </ul>
                    ...
                    <aside id="sidebar-wrapper">
                      ...
                      <div class="sidebar-brand sidebar-brand-sm">
                        ...
                        <ul class="sidebar-menu active">
                          ...
                          <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-align-justify"></i><span style="color:white">Al-Quran</span></a>
                          </li>
                        </ul>
                    </aside>
                  </div>
