    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="" style="font-size: 16px; color:#2F2F2F">{{ $home->surat }}</a></td>
          <td> <a href="" style="font-size: 16px; color:#2F2F2F">{{ $home->qori }}</a></td>
          <td> <a href="" style="font-size: 16px; color:#2F2F2F">{{ $home->rewayat }}</a></td>
          <td class="row">
            <div class="col-10">
              <span>0:00:00</span>
            </div>
