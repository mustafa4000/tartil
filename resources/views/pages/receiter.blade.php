          ...
          <div>
            <div class="card-deck">
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.play') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdallah Kamel</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.AlAhmed') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdel Aziz Al Ahmed</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Warsh') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdelhamid Hssain - Warsh</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Brown') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Aziz Brown</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Basit') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Basit</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Obeikan') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Mohsen Al Obeikan</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Alburaimi') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdullah Al Buraimi</a>
                </div>
              </div>
            </div>
            <br>
            <div class="card-deck">
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Alqasim') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Muhsin Al Qasim</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.AlYusuf') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Rahman Al Yusuf</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Aloosi') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Rahman Jamal Aloosi</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Haneef') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Wadood Haneef</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Alarkani') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdul Wali Al Arkani</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Alhadidi') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdulkabir Al Hadidi</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Ghamdi') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Saad al-Ghamdi</a>
                </div>
              </div>
            </div>
            <br>
            <div class="card-deck">
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Arrifai') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Hani Ar-Rifai</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Thubaity') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">AbdulBari ath-Thubaity</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Sudais') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abdur Rahman As-Sudais</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Shatri') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Abu Bakr al-Shatri</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Alajmi') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Ahmed Al Ajmi</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Jibreen') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Ibrahim Al-Jibreen</a>
                </div>
              </div>
              <div class="card w3-white w3-hover-shadow">
                ...
                <div class="card-body text-center">
                  <a href="{{ route('pages.receiter.Dossari') }}" class="card-title" style="font-size: 11px; color:#2F2F2F; text-align: center;">Yasser Al Dossari</a>
                </div>
              </div>
            </div>
          </div>
