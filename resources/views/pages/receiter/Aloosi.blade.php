...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/abdulraman.jpg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdul Rahman Jamal Aloosi</h5>
    ...
    <br><br>
    <b style="color: #2F2F2F;">About Abdul Rahman Al Yusuf</b>
    <p style="color: #2F2F2F;">"What I love most in my life is reading the Koran and praising it, and I hope Allah SWT will make it an argument for me and not against me on the day of judgment".</p>
    <p style="color: #2F2F2F;">"Abdul Rahman Jamal Aloosi, born in Saudi Arabia on 5 August 1981, Sheikh Abdulrahman bin Jamal describes himself in powerful quotes that speak volumes about his undeniable position as one of the most prominent Qaris in Saudi Arabia.</p>
    <p style="color: #2F2F2F;">His unprecedented love for the Koran motivated him to study the sciences of the Qur'an recitation and enabled him to obtain certification according to A'n Assem's method of recitation.</p>
    <p style="color: #2F2F2F;">The Sheikh was also appointed as a professor and as Imam at the Al Ikhlass (Al Khabar) Mosque in Saudi Arabia.</p>
</section>
@endsection