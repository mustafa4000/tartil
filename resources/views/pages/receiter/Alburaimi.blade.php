...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/Abdullah_al_buraimi.jpeg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdullah Al Buraimi</h5>
              <p class="card-text" style="color: #9D9D9D;">Country: UEA</p>
    ...
    <br><br>
    <b style="color: #2F2F2F;">About Abdullah Al Buraimi</b>
    <p style="color: #2F2F2F;">The sweetness came down from her enchanting voice. That's Sheikh Abdullah al Buraimi for you. Born in the UAE, Abdullah Bin Abdul Karim Al Buraimi Al Zaraouni has many roles - Qur'an reader, Imam and preacher.</p>
    <p style="color: #2F2F2F;">The Sheikh holds a Masters degree in Al Shari'a (Comparative Fiqh) and a Cambridge International Diploma in Information Technology Skills. Currently, he is completing a doctorate degree in Sharia from IIU in Malaysia.</p>
    <p style="color: #2F2F2F;">While in the UAE, the Shaykh took on the following responsibilities:</p>
    <p style="color: #2F2F2F;">1999 - 2001: Acting head of the Islamic Affairs Department at Al Sharika</p>    <p style="color: #2F2F2F;">He was granted the coveted designation as the Director of the legal affairs of King Faysal’s Hospital and the Research Center in Jeddah.</p>
</section>
@endsection
