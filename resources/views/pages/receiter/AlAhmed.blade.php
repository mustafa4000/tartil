...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/Abdel Aziz Al Ahmed.jpeg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdel Aziz Al Ahmed</h5>
    ...
    <br><br>
    <b style="color: #2F2F2F;">About Abdel Aziz Al Ahmed</b>
    <p style="color: #2F2F2F;">Abdel Aziz Al Ahmed, born on 20 Rajab, 1387 Hijriah in Buraida, Saudi Arabia, Abdel Aziz Ibn Abdullah Ibn Mohamed Al Ahmad, is a well-known Imam and Qari.</p>
    <p style="color: #2F2F2F;">Di usia yang sangat muda, Abdel Aziz Ibn Abdullah hafal Alquran dari Syekh terkenal seperti Soulaimane Al Ghafis, Abdul Aziz Al Harbi dan Abdullah Al Bassam, Sheik Aid Alyahya dan Mohamed Al Mansour. Dia juga mengambil pelajaran dalam Hadits.</p>
    <p style="color: #2F2F2F;">The Sheikh memperoleh gelar Sarjana dalam ilmu psikologi dari Universitas Mohamed Ibn Saud pada tahun 1410 Hijrah. Dia melanjutkan untuk mendapatkan gelar Master dan doktor pertama pada tahun 1423 Hijrah setelah bekerja sebagai guru di Universitas yang sama. Ia juga bergabung dengan fakultas Universitas Al Kassim pada tahun yang sama. Setelah itu, ia melanjutkan untuk mendapatkan gelar doktor keduanya dalam Ilmu Syariah dan Islam.</p>
</section>
@endsection