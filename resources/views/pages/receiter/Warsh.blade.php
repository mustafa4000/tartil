...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/Abdelhamid Hssain - Warsh.jpeg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdelhamid Hssain - Warsh</h5>
              <p class="card-text" style="color: #9D9D9D;">Country: Maroko</p>
    ...
    <p class="card-text"><small class="text-muted" style="color: #9D9D9D;">Nama Surat</small></p>
    <div class="row col">
        <div class=" col-0">
    ...
    <br><br>
    <b style="color: #2F2F2F;">About Abdelhamid Hssain - Warsh</b>
    <p style="color: #2F2F2F;">Sheikh Hani Ar-Rifai is the Imam and Khateeb of Masjid Anani in Jeddah, Saudi Arabia</p>
    <p style="color: #2F2F2F;">During his learning of the Holy Quran, the esteemed Shaykh has had the privilege of being in the company of and attaining knowledge from other well-known Shuyookh such as Shaykh Muhammad Ibn Abdu Rahim Achichin, Sheikh Ali Jaber and Sheikh Muhammad Yusuf.</p>
    ...
    <p style="color: #2F2F2F;">Owing to the emotional and soul warming rendition of the Book of Allah, Sheikh Hani Ar-Rifai was elected as a  special reciter of the Holy Quran in the Royal Court by the Saudi Ministry of Culture and Information.</p>
    <p style="color: #2F2F2F;">He was granted the coveted designation as the Director of the legal affairs of King Faysal’s Hospital and the Research Center in Jeddah.</p>
