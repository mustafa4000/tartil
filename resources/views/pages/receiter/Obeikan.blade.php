...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/Abdul Mohsen Al Obeikan.jpg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdul Mohsen Al Obeikan</h5>
    ...
    <br><br>
    <b style="color: #2F2F2F;">About Abdul Mohsen Al Obeikan</b>
    <p style="color: #2F2F2F;">Abdul Mohsen Al Obeikan was a Saudi Arabian since birth (1372 Hijrah), Sheikh Abdul Mohsen bin Nasser Al Obeikan studied in the city of Al Taif and joined the Sharia University in Mecca. After that, he completed his studies at the Sharia University in Riyadh.</p>
    <p style="color: #2F2F2F;">The sheikh had been exposed to Imamat since childhood because of his father, but he officially entered this field in his college years when he was appointed imam and khateeb at the Mohammad Bin Abdulrahman Al Obeikan mosque, and at the Al Jawhara mosque in Riyadh.</p>
    <p style="color: #2F2F2F;">His teachers included prominent figures such as Sheikh Muhammad Makhdoum Al Bukhari, Syekh Muhammad Sukar and Sheikh Abdullah Bin Hamid.</p>
    <p style="color: #2F2F2F;">Apart from that, he is also a writer, researcher, preacher and lecturer who is a member of the Shura Council of Saudi Arabia and the judicial consultant of the Saudi Ministry of Justice. He also contributed to the field of Arabic literature with books such as "Khawarij and the Renewed Thought", "Khawarij Al Asr" and other writings. Apart from that, he is also involved in the media through press articles and animation programs through Saudi channels.</p>
    <p style="color: #2F2F2F;">Sheikh has also been a mentor to many shuyookh including Sheikh Abdullah Al Yahya, Sheikh Abdulrahman Al Waadan and Sheikh Ahmed Al Mazrouae.</p>
</section>
@endsection