...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/abdulwali.jpeg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdul Wali Al Arkani</h5>
    ...
    <b style="color: #2F2F2F;">About Abdul Wali Al Arkani</b>
    <p style="color: #2F2F2F;">Abdul Wali Al Arkani is usually called Abu Muad, Sheikh Abdul Wali Al Arkani was born in 1983 in Mecca.</p>
    <p style="color: #2F2F2F;">The Shaykh learned the Koran from his father at the age of 14 and then under many shuyookhs. After that, he moved to Mecca and studied under the guidance of prominent shuyookhs such as Sheikh Harun Dahir, the late Shaykh Muhammad Kabir, Shaykh Muhammad Idriss Abbass and others.</p>
    <p style="color: #2F2F2F;">In addition, he joined the Al Arqam Ibn Abu Al Arqam Institute at Masjid Al Haram and graduated in 1997. His first Imamate was at the Sheikh Muhammad Saleh Jamal mosque in Mecca at the age of 13.</p>
    <p style="color: #2F2F2F;">He is one of the well-known Quran reciters and currently serves as the Imam of the Khadem Al Haramein Al-Sharefein Mosque in Jeddah, Saudi Arabia. In addition, the recordings were broadcast on several Arab religious channels and were also recorded for the benefit of the masses.</p>
</section>
@endsection