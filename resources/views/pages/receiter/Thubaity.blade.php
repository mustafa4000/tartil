...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/AbdulBari-ath-Thubaity.jpeg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">AbdulBari ath-Thubaity</h5>
    ...
    <br><br>
    <b style="color: #2F2F2F;">About AbdulBari ath-Thubaity</b>
    <p style="color: #2F2F2F;">Sheikh Abdul Bari Ath Thobaity was born in Makkah, Saudi Arabia in 1380 Hijrah.</p>
    <p style="color: #2F2F2F;">In 1405 Hijrah, the Shaykh graduated in Science from King Fahd Abdul Aziz University in Jeddah, after which, he enrolled at Umm Al Qura University for a higher degree in Sharia. He achieved it in 1409 Hijrah. After that, he obtained his Master's degree from the Shari'ah faculty in 1415 Hijrah, from the same university.</p>
    <p style="color: #2F2F2F;">At the age of 19, Sheikh Abdul Bari Ath Thobaity served as a teacher and memorizer of the Koran while guiding a Quran memorization session in Jeddah.</p>
    <p style="color: #2F2F2F;">The Shaykh was also awarded the position of Imam Ad preacher at the Prophet's Mosque in Medina.</p>
</section>
@endsection