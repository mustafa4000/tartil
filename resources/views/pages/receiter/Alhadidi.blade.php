...
<section class="section">
    <h3 style="color: #2F2F2F;">Receiter</h3>
        <div class="row g-0">
          <div class="col-md-2">
            <img class="img-rounded" src="{{ url('/assets/imgtartil/abdulkabir.jpg') }}" width="132px" height="132px" style="border-radius: 8px;">
          </div>
          <div class="col-md-4">
            <div class="card-body">
              <h5 class="card-title" style="color: #2F2F2F;">Abdulkabir Al Hadidi</h5>
    ...
    <br><br>
    <b style="color: #2F2F2F;">About Abdulkabir Al Hadidi</b>
    <p style="color: #2F2F2F;">Abdulkabir Al Hadidi was born on January 1, 1963, Sheikh Abdulkabir al Hadidi was born in Essaouira, a province of Morocco. The sheikh completed memorizing the Koran in Casablanca.</p>
    <p style="color: #2F2F2F;">The Sheikh received the same certification from the scientific board of Casablanca in October 1992. In addition, he also received a license degree specializing in Islamic studies.</p>
    <p style="color: #2F2F2F;">One of his most interesting projects is 'Learn the Koran in your home', starting to facilitate the recitation of the Koran for each individual regardless of age and place, with a special emphasis on those who cannot frequent the mosque to memorize.</p>
    <p style="color: #2F2F2F;">Sheikh Abdulkbir El Hadidi has held the position of Imam and khateeb at Masjid Al Sabil in Casablanca and has taught the Koran, the science behind his recitation for more than 20 years.</p>
</section>
@endsection