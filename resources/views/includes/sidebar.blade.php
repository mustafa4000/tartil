  ...
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand sidebar-brand-sm">
      ...
      <ul class="sidebar-menu active">
        ...
        <li class="nav-item dropdown">
          <a href="{{ route('pages.receiter') }}"><i class="fas fa-user"></i><span style="color:white">Reciter</span></a>
        </li>
        <li class="nav-item dropdown">
          <a href="{{ route('pages.alquran') }}"><i class="fas fa-book-open"></i><span style="color:white">Alquran</span></a>
        </li>
        <li class="nav-item dropdown">
