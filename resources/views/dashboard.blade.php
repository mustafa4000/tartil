        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    ...
                    <div class="search-element">
                        <input class="form-control" type="search" placeholder="Search" aria-label="Search"
                            data-width="600" style="background: #F6F6F6;">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="mr-3"><a href="{{ route('pages.donate.index') }}" style="color:#2F2F2F;"><i
                                class="far fa-donate fa-1x" style="width: 18px"></i> <b class="mr-2"
                                style="font-size: 18px">Donasi</b> </a>
                    </li>
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        <li class="nav-item dropdown">
                            <a href="{{ route('dashboard') }}"><i class="fas fa-home fa-2x"
                                    style="color:#5CBB87;"></i><span
                                    style="color:#5CBB87; font-size: 16px;">Home</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="{{ route('pages.favorite') }}"><i class="fas fa-star fa-2x"
                                    style="color:#5CBB87;"></i><span
                                    style="color:#5CBB87; font-size: 16px;">Favorite</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="{{ route('pages.receiter') }}"><i class="fas fa-user fa-2x"
                                    style="color:#5CBB87;"></i><span
                                    style="color:#5CBB87; font-size: 16px;">Reciter</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="{{ route('pages.alquran') }}"><i class="fas fa-book-open fa-2x"
                                    style="color:#5CBB87;"></i><span
                                    style="color:#5CBB87; font-size: 16px;">Alquran</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="" class="nav-link" data-toggle="dropdown"><i class="fas fa-align-justify fa-2x"
                                    style="color:#5CBB87;"></i> <span
                                    style="color:#5CBB87; font-size: 16px;">Playlist</span> <i href=""
                                    class="far fa-plus-circle fa-2x" style="color: white;"> </i> </a>
                            <ul class="dropdown-menu" style="display: none;">
                                <hr style="background: white">
                                <li><a class="nav-link" style="color:#5CBB87; font-size: 16px;"
                                        href="{{ route('pages.playlist') }}">Playlist 1 </a></li>
                                <li><a class="nav-link" style="color:#5CBB87; font-size: 16px;"
                                        href="bootstrap-badge.html">For Today</a></li>
                                <li><a class="nav-link" style="color:#5CBB87; font-size: 16px;"
                                        href="bootstrap-breadcrumb.html">NIight</a></li>
                                <li><a class="nav-link" style="color:#5CBB87; font-size: 16px;"
